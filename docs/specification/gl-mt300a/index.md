...
![gl-mt300a pcb pinout](https://static.gl-inet.com/docs/router/en/2/hardware/mt300a/src/pinout_mt300A.jpg){class="glboxshadow"} 

## MicroSD Card Slot
GL-MT300A Router has a SD card slot inside. You need to open the case and insert the MicroSD card. 
![gl-mt300a microsd card slot](https://static.gl-inet.com/docs/router/en/2/hardware/mt300a/src/mt300A_1000x1000_41.jpg){class="glboxshadow"}
