...
![admin password](https://static.gl-inet.com/docs/en/3/setup/convexa_b/more_settings/admin_password.jpg)
...
![lan ip](https://static.gl-inet.com/docs/en/3/setup/convexa_b/more_settings/lan_ip.jpg)
...
![time zone](https://static.gl-inet.com/docs/en/3/setup/convexa_b/more_settings/time_zone.jpg)
...
![mac clone](https://static.gl-inet.com/docs/en/3/setup/convexa_b/more_settings/mac_clone.jpg)
...
![custom dns server](https://static.gl-inet.com/docs/en/3/setup/gl-sf1200/dnsserver.jpg)
...
![network mode](https://static.gl-inet.com/docs/en/3/setup/gl-sf1200/networkmode.jpg)
...
![revert firmware](https://static.gl-inet.com/docs/en/3/setup/convexa_b/more_settings/revert_firmware.jpg)
...
![advanced](https://static.gl-inet.com/docs/en/3/setup/gl-sf1200/luci.jpg)

Click **install Luci**, you will get the succefully installed. 

![advanced](https://static.gl-inet.com/docs/en/3/setup/gl-sf1200/lucisuccess.jpg)


Click **Close**, then click the link of Luci, you will get the Luci webUI

![advanced](https://static.gl-inet.com/docs/en/3/setup/gl-sf1200/Luci_login.jpg)
