...
![upgrade](https://static.gl-inet.com/docs/en/3/setup/convexa_b/upgrade/firmware.jpg){class="glboxshadow"}
...
![online upgrade](https://static.gl-inet.com/docs/en/3/setup/convexa_b/upgrade/firmware1.jpg){class="glboxshadow"}
...
![upload firmware](https://static.gl-inet.com/docs/en/3/setup/convexa_b/upgrade/firmware2.jpg){class="glboxshadow"}
...
- GL-SF1200: [https://dl.gl-inet.com/firmware/sf1200/](https://dl.gl-inet.com/firmware/sf1200/)
...
![auto upgrade](https://static.gl-inet.com/docs/en/3/setup/convexa_b/upgrade/firmware3.jpg){class="glboxshadow"}
