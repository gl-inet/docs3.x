# Getting Started with microuter-N300

Model: microuter-N300

![router](https://static.gl-inet.com/docs/router/en/3/setup/microuter-n300/first_time_setup/router.jpg){class="glboxshadow"}
...
![Power on](https://static.gl-inet.com/docs/router/en/3/setup/microuter-n300/first_time_setup/power.jpg){class="glboxshadow"}
...
*Note: **microuter-N300** has only 1 Ethernet port which works as WAN. You can only connect to it via Wi-Fi when you first set up the router. Once you have connected to it, you can change the WAN port to LAN port in [Internet](internet.md#1-cable) so that you can connect to it via LAN.*
...
![initial setup](https://static.gl-inet.com/docs/router/en/3/setup/microuter-n300/first_time_setup/welcome_page_microuter-n300.png){class="glboxshadow"}
...
![admin panel](https://static.gl-inet.com/docs/router/en/3/setup/microuter-n300/first_time_setup/admin_panel_microuter-n300.png){class="glboxshadow"}
