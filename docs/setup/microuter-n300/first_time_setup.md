...
![router](https://static.gl-inet.com/docs/en/3/setup/microuter-n300/first_time_setup/router.jpg){class="glboxshadow"}
...
![Power on](https://static.gl-inet.com/docs/en/3/setup/microuter-n300/first_time_setup/power.jpg){class="glboxshadow"}
