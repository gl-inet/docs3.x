...
![admin password](https://static.gl-inet.com/docs/router/en/3/setup/microuter-n300/more_settings/admin_password.png){class="glboxshadow"}
...
![lan ip](https://static.gl-inet.com/docs/router/en/3/setup/microuter-n300/more_settings/lan_ip.png){class="glboxshadow"}
...
![time zone](https://static.gl-inet.com/docs/router/en/3/setup/microuter-n300/more_settings/time_zone.png){class="glboxshadow"}
...
![mac clone](https://static.gl-inet.com/docs/router/en/3/setup/microuter-n300/more_settings/mac_clone.png){class="glboxshadow"}
...
![custom dns server](https://static.gl-inet.com/docs/router/en/3/setup/microuter-n300/more_settings/custom_dns_server.png){class="glboxshadow"}
...
![network mode](https://static.gl-inet.com/docs/router/en/3/setup/microuter-n300/more_settings/network_mode.png){class="glboxshadow"}
...
![revert firmware](https://static.gl-inet.com/docs/router/en/3/setup/microuter-n300/more_settings/revert_firmware.png){class="glboxshadow"}
...
![advanced](https://static.gl-inet.com/docs/router/en/3/setup/microuter-n300/more_settings/advanced.png){class="glboxshadow"}
