# Getting Started with GL.iNet Spitz

Model: GL-X750(Spitz)

![router](https://static.gl-inet.com/docs/router/en/3/setup/gl-x750/first_time_setup/router.jpg){class="glboxshadow"}
...
![Power on](https://static.gl-inet.com/docs/router/en/3/setup/gl-x750/first_time_setup/power1.jpg){class="glboxshadow"}
...
![connect via lan](https://static.gl-inet.com/docs/router/en/3/setup/gl-x750/first_time_setup/connect.jpg){class="glboxshadow"}
...
![initial setup](https://static.gl-inet.com/docs/router/en/3/setup/gl-x750/first_time_setup/welcome_page_gl-x750.png){class="glboxshadow"}
...
![setup admin panel](https://static.gl-inet.com/docs/router/en/3/setup/share/first_time_setup/setup_admin_password.png){class="glboxshadow"}
...
![admin panel](https://static.gl-inet.com/docs/router/en/3/setup/gl-x750/first_time_setup/admin_panel_gl-x750.png){class="glboxshadow"}
