...
![initial setup](https://static.gl-inet.com/docs/en/3/setup/gl-x750/first_time_setup/welcome.jpg){class="glboxshadow"}
...
![admin panel](https://static.gl-inet.com/docs/en/3/setup/gl-x750/first_time_setup/main_ui.jpg){class="glboxshadow"}
