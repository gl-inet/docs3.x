...
![connection methods](https://static.gl-inet.com/docs/en/3/setup/spitz/internet/4ways.jpg){class="glboxshadow"}

Click `INTERNET` to create an Internet connection.

![internet](https://static.gl-inet.com/docs/en/3/setup/spitz/internet/internet.jpg){class="glboxshadow"}
...
![modem](https://static.gl-inet.com/docs/en/3/setup/spitz/internet/modem2.jpg){class="glboxshadow"}
...
![AT command](https://static.gl-inet.com/docs/en/3/setup/spitz/internet/at_command.jpg){class="glboxshadow"}
...
![tethering](https://static.gl-inet.com/docs/en/3/setup/spitz/internet/tethering.jpg){class="glboxshadow"}
