...
![internet page of gl-x750](https://static.gl-inet.com/docs/router/en/3/setup/gl-x750/internet/internet_page_gl-x750.png){class="glboxshadow"}
...
![connection methods](https://static.gl-inet.com/docs/router/en/3/setup/gl-x750/internet/4ways.jpg){class="glboxshadow"}
