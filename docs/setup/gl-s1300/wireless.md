...
![wireless](https://static.gl-inet.com/docs/en/3/setup/convexa_s/wireless/status.jpg)



Click `Modify` to change the settings of the wireless network.

![wifi modify](https://static.gl-inet.com/docs/en/3/setup/convexa_s/wireless/setting.jpg)
