...
![internet page of gl-ax1800](https://static.gl-inet.com/docs/router/en/3/setup/gl-ax1800/internet/internet_page_ax1800.png){class="glboxshadow"}
...
![connection method](https://static.gl-inet.com/docs/router/en/3/setup/gl-ax1800/internet/4-internet-connection-ax1800.png){class="glboxshadow"}
...
![cable section of internet](https://static.gl-inet.com/docs/router/en/3/setup/share/internet/cable_section_of_internet.png){class="glboxshadow"}
...
![dhcp of internet](https://static.gl-inet.com/docs/router/en/3/setup/share/internet/dhcp_internet.png){class="glboxshadow"}
...
![repeater scan Wi-Fi](https://static.gl-inet.com/docs/router/en/3/setup/share/internet/repeater_scan.png){class="glboxshadow"}
...
![usb modem auto setup](https://static.gl-inet.com/docs/router/en/3/setup/share/internet/usb_modem/usb_modem_auto_setup.png){class="glboxshadow"}
...
![usb modem connected](https://static.gl-inet.com/docs/router/en/3/setup/share/internet/usb_modem/usb_modem_connected.png){class="glboxshadow"}
...
1. Please note that there is your carrier name in the upper left corner of it. Click `Abort`, wait a while, and if it doesn't work, click `Modem Reset`.
    ...
    ![usb modem insert sim card](https://static.gl-inet.com/docs/router/en/3/setup/share/internet/usb_modem/usb_modem_abort.png){class="glboxshadow"}
...
3. Use a computer or another phone, connect to the router, then go to web Admin Panel, on the left side bar, choose "INTERNET" and click "Connect" in the middle of the page.
    ...
    ![tethering connect](https://static.gl-inet.com/docs/router/en/3/setup/share/internet/tethering/tethering_connect.png){class="glboxshadow"}
...
4. It will show connected information on the top of your phone screen and the web Admin Panel once you connect successfully.
    ...
    ![tethering](https://static.gl-inet.com/docs/router/en/3/setup/share/internet/tethering/tethering_connected_mt300n-v2.png){class="glboxshadow"}
...
![tethering](https://static.gl-inet.com/docs/router/en/3/setup/share/internet/tethering/tethering_connect.png){class="glboxshadow"}
