...
![cable section of internet](https://static.gl-inet.com/docs/en/3/setup/gl-ax1800/internet/cable_section_of_internet.png){class="glboxshadow"}
...
![dhcp](https://static.gl-inet.com/docs/en/3/setup/gl-ax1800/internet/dhcp_method.png){class="glboxshadow"}
...
![static](https://static.gl-inet.com/docs/en/3/setup/gl-ax1800/internet/static_method.png){class="glboxshadow"}
...
![PPPoE](https://static.gl-inet.com/docs/en/3/setup/gl-ax1800/internet/pppoe_method.png){class="glboxshadow"}
...
![repeater scan wifi](https://static.gl-inet.com/docs/en/3/setup/gl-ax1800/internet/repeater_scan.png){class="glboxshadow"}

Choose a SSID from the drop-down list and enter its password. You can also enable the **Remember** button to save the current chose wireless network. Finally, click `Join`.

![wifi connect](https://static.gl-inet.com/docs/en/3/setup/gl-ax1800/internet/repeater_connect.png){class="glboxshadow"}
...
![modem](https://static.gl-inet.com/docs/en/3/setup/gl-ax1800/internet/modem1.png){class="glboxshadow"}
...
![modem](https://static.gl-inet.com/docs/en/3/setup/gl-ax1800/internet/modem4.jpg){class="glboxshadow"}

It is connected when the IP address of your SIM card shows up.

![modem connect](https://static.gl-inet.com/docs/en/3/setup/gl-ax1800/internet/modem2.png){class="glboxshadow"}

![modem connected](https://static.gl-inet.com/docs/en/3/setup/gl-ax1800/internet/modem3.png){class="glboxshadow"}
...
![tethering](https://static.gl-inet.com/docs/en/3/setup/gl-ax1800/internet/tethering.png){class="glboxshadow"}
