...
![firmware](https://static.gl-inet.com/docs/en/3/setup/gl-usb150/upgrade/firmware.jpg){class="glboxshadow"}
...
![online upgrade](https://static.gl-inet.com/docs/en/3/setup/gl-usb150/upgrade/firmware1.jpg){class="glboxshadow"}
...
![upload firmware](https://static.gl-inet.com/docs/en/3/setup/gl-usb150/upgrade/firmware2.jpg){class="glboxshadow"}
...
![auto upgrade](https://static.gl-inet.com/docs/en/3/setup/gl-usb150/upgrade/firmware3.jpg){class="glboxshadow"}
