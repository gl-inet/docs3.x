...
![button settings](https://static.gl-inet.com/docs/router/en/3/setup/share/more_settings/button_settings.png){class="glboxshadow"}
...
![network mode](https://static.gl-inet.com/docs/router/en/3/setup/share/more_settings/network_mode_no_wds.png){class="glboxshadow"}
