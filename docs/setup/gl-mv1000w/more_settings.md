...
![button settings](https://static.gl-inet.com/docs/en/3/setup/brume/more_settings/button_setting.png){class="glboxshadow"}
...
![network mode](https://static.gl-inet.com/docs/en/3/setup/brume/more_settings/network_mode.png){class="glboxshadow"}
...
![advanced](https://static.gl-inet.com/docs/en/3/setup/brume/more_settings/luci.png){class="glboxshadow"}
