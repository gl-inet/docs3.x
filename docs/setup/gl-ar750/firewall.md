...
![Firewall](https://static.gl-inet.com/docs/en/3/setup/travel_ac_router/firewall/firewall.jpg){class="glboxshadow"}
...
![Port Forwards](https://static.gl-inet.com/docs/en/3/setup/travel_ac_router/firewall/port_forwards.jpg){class="glboxshadow"}
...
![Port Forwards](https://static.gl-inet.com/docs/en/3/setup/travel_ac_router/firewall/open_port.jpg){class="glboxshadow"}
...
![Port Forwards](https://static.gl-inet.com/docs/en/3/setup/travel_ac_router/firewall/DMZ.jpg){class="glboxshadow"}