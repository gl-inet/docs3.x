# GL.iNet トラベルACルーターを使い始めよう

モデル:

GL-AR750, GL-AR750-PoE

![router](https://static.gl-inet.com/docs/router/jp/3/setup/gl-ar750/first_time_setup/router.jpg)
...
![initial setup](https://static.gl-inet.com/docs/router/jp/3/setup/gl-ar750/first_time_setup/welcome.png)
...
![admin panel](https://static.gl-inet.com/docs/router/jp/3/setup/gl-ar750/first_time_setup/main_ui.png)
