# Getting Started with GL.iNet GL-AR750(Creta)

Models:

GL-AR750, GL-AR750-PoE

![router](https://static.gl-inet.com/docs/router/en/3/setup/gl-ar750/first_time_setup/router.jpg){class="glboxshadow"}
...
![connect via lan](https://static.gl-inet.com/docs/router/en/3/setup/gl-ar750/first_time_setup/connect.jpg){class="glboxshadow" width="700"}
...
![initial setup](https://static.gl-inet.com/docs/router/en/3/setup/gl-ar750/first_time_setup/welcome_page_gl-ar750.png){class="glboxshadow"}
...
![admin panel](https://static.gl-inet.com/docs/router/en/3/setup/gl-ar750/first_time_setup/admin_panel_gl-ar750.png){class="glboxshadow"}
