...
![wireless](https://static.gl-inet.com/docs/en/3/setup/gl-ar750/wireless/status.jpg){class="glboxshadow"}



Click `Modify` to change the settings of the wireless network.

![wifi modify](https://static.gl-inet.com/docs/en/3/setup/gl-ar750/wireless/setting.jpg){class="glboxshadow"}
