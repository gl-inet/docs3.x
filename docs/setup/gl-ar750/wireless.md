...
![wireless](https://static.gl-inet.com/docs/router/jp/3/setup/gl-ar750/wireless/status.png)

`修正`をクリックして、無線ネットワーク設定を変更します。

![wifi modify](https://static.gl-inet.com/docs/router/jp/3/setup/gl-ar750/wireless/setting.png)
