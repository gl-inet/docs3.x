...
![admin password](https://static.gl-inet.com/docs/en/3/setup/gl-mifi/more_settings/admin_password.jpg){class="glboxshadow"}
...
![lan ip](https://static.gl-inet.com/docs/en/3/setup/gl-mifi/more_settings/lan_ip.jpg){class="glboxshadow"}
...
![time zone](https://static.gl-inet.com/docs/en/3/setup/gl-mifi/more_settings/time_zone.jpg){class="glboxshadow"}
...
![mac clone](https://static.gl-inet.com/docs/en/3/setup/gl-mifi/more_settings/mac_clone.jpg){class="glboxshadow"}
...
![custom dns server](https://static.gl-inet.com/docs/en/3/setup/gl-mifi/more_settings/custom_dns_server.jpg){class="glboxshadow"}
...
![network](https://static.gl-inet.com/docs/en/3/setup/gl-mifi/more_settings/network_mode.jpg){class="glboxshadow"}
...
![revert firmware](https://static.gl-inet.com/docs/en/3/setup/gl-mifi/more_settings/revert_firmware.jpg){class="glboxshadow"}
...
![advanced](https://static.gl-inet.com/docs/en/3/setup/gl-mifi/more_settings/advanced.jpg){class="glboxshadow"}
