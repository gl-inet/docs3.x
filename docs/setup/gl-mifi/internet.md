...
![](https://static.gl-inet.com/docs/en/3/setup/4g_smart_router/internet/4ways.jpg){class="glboxshadow"}

Click `INTERNET` to create an Internet connection.

![internet](https://static.gl-inet.com/docs/en/3/setup/4g_smart_router/internet/internet.jpg){class="glboxshadow"}
