...
![internet page of gl-mifi](https://static.gl-inet.com/docs/en/3/setup/gl-mifi/internet/internet_page_gl-mifi.png){class="glboxshadow"}
...
![connection method](https://static.gl-inet.com/docs/en/3/setup/gl-mifi/internet/4ways.jpg){class="glboxshadow"}
