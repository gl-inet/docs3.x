...
![internet page of gl-mifi](https://static.gl-inet.com/docs/router/en/3/setup/gl-mifi/internet/internet_page_gl-mifi.png){class="glboxshadow"}
...
![connection method](https://static.gl-inet.com/docs/router/en/3/setup/gl-mifi/internet/4ways.jpg){class="glboxshadow"}
...
GL-MiFi has a built-in 3G/4G modem. It has different options of 3G/4G module which you can choose before purchase.
