...
![router](https://static.gl-inet.com/docs/router/en/3/setup/mini_router/first_time_setup/router.jpg){class="glboxshadow"}
...
![Power on](https://static.gl-inet.com/docs/router/en/3/setup/mini_router/first_time_setup/power.jpg){class="glboxshadow"}
...
![connect via lan](https://static.gl-inet.com/docs/router/en/3/setup/mini_router/first_time_setup/connect.jpg){class="glboxshadow"}
...
![initial setup](https://static.gl-inet.com/docs/router/en/3/setup/mini_router/first_time_setup/welcome_page_mt300n-v2.png){class="glboxshadow"}
...
![password](https://static.gl-inet.com/docs/router/en/3/setup/share/first_time_setup/setup_admin_password.png){class="glboxshadow"}
...
![admin panel](https://static.gl-inet.com/docs/router/en/3/setup/mini_router/first_time_setup/admin_panel_mt300n-v2.png){class="glboxshadow"}
