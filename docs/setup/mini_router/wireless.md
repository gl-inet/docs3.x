...
Mini routers only have 2.4G Wi-Fi.

## Wireless

![wireless](https://static.gl-inet.com/docs/router/en/3/setup/mini_router/wireless/wifi_status_2.4g_mt300n-v2.png){class="glboxshadow"}
...
![guest Wi-Fi 2.4g status](https://static.gl-inet.com/docs/router/en/3/setup/mini_router/wireless/wifi_status_2.4g_guest_mt300n-v2.png){class="glboxshadow"}
