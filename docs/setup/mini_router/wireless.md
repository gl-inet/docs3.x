...
![wireless](https://static.gl-inet.com/docs/en/3/setup/mini_router/wireless/status.jpg){class="glboxshadow"}



Click `Modify` to change the settings of the wireless network.

![modify wifi](https://static.gl-inet.com/docs/en/3/setup/mini_router/wireless/setting.jpg){class="glboxshadow"}
