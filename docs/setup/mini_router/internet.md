...
![internet page of gl-mt300n-v2](https://static.gl-inet.com/docs/router/en/3/setup/mini_router/internet/internet_page_gl-mt300n-v2.png){class="glboxshadow"}
...
![connection method](https://static.gl-inet.com/docs/router/en/3/setup/mini_router/internet/4ways.jpg){class="glboxshadow"}
