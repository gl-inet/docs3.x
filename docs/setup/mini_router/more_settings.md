...
![admin password](https://static.gl-inet.com/docs/en/3/setup/mini_router/more_settings/admin_password.jpg){class="glboxshadow"}
...
![lan ip](https://static.gl-inet.com/docs/en/3/setup/mini_router/more_settings/lan_ip.jpg){class="glboxshadow"}
...
![time zone](https://static.gl-inet.com/docs/en/3/setup/mini_router/more_settings/time_zone.jpg){class="glboxshadow"}
...
![custom dns server](https://static.gl-inet.com/docs/en/3/setup/mini_router/more_settings/custom_dns_server.jpg){class="glboxshadow"}
