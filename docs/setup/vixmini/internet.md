...
![internet](https://static.gl-inet.com/docs/en/3/setup/vixmini/internet/internet.jpg)
...
![cable](https://static.gl-inet.com/docs/en/3/setup/vixmini/internet/cable.jpg)
...
![cable](https://static.gl-inet.com/docs/en/3/setup/vixmini/internet/dhcp_page.jpg)
...
![dhcp](https://static.gl-inet.com/docs/en/3/setup/vixmini/internet/dhcp.jpg)
...
![static](https://static.gl-inet.com/docs/en/3/setup/vixmini/internet/static.jpg)
...
![PPPoE](https://static.gl-inet.com/docs/en/3/setup/vixmini/internet/pppoe_page.jpg)
...
![repeater scan](https://static.gl-inet.com/docs/en/3/setup/vixmini/internet/wisp1.jpg)



Choose a SSID from the drop-down list and enter its password. You can also enable the **Remember** button to save the current chose wireless network. Finally, click `Join`.

![connect wifi](https://static.gl-inet.com/docs/en/3/setup/vixmini/internet/wisp2.jpg)
