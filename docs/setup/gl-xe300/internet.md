...
![](https://static.gl-inet.com/docs/en/3/setup/Puli/internet/4ways.jpg)

Click `INTERNET` to create an Internet connection.

![internet](https://static.gl-inet.com/docs/en/3/setup/Puli/First-time%20Setup/Admin%20Panel.png)
