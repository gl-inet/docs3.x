...
![router](https://static.gl-inet.com/docs/en/3/setup/gl-xe300/first_time_setup/router.jpg){class="glboxshadow"}
...
![Power on](https://static.gl-inet.com/docs/en/3/setup/gl-xe300/first_time_setup/power1.jpg){class="glboxshadow"}
...
![connect via lan](https://static.gl-inet.com/docs/en/3/setup/gl-xe300/first_time_setup/connect.jpg){class="glboxshadow"}
...
![initial setup](https://static.gl-inet.com/docs/en/3/setup/gl-xe300/first_time_setup/welcome_page_xe300.png){class="glboxshadow"}
