...
![wifi switch](https://static.gl-inet.com/docs/en/3/setup/gl-e750/wireless/wifi.png){class="glboxshadow"}



Click `Modify` to change the settings of the wireless network.

![wifi switch](https://static.gl-inet.com/docs/en/3/setup/gl-e750/wireless/wireless.png){class="glboxshadow"}
