...
![button settings](https://static.gl-inet.com/docs/router/en/3/setup/gl-e750/more_settings/button_settings_e750.png){class="glboxshadow"}
...
![MCU settings](https://static.gl-inet.com/docs/router/en/3/setup/gl-e750/more_settings/mcu_settings.png){class="glboxshadow"}
