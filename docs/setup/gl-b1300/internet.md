...
![modem](https://static.gl-inet.com/docs/en/3/setup/convexa_b/internet/modem2.jpg){class="glboxshadow"}
...
![tethering](https://static.gl-inet.com/docs/en/3/setup/convexa_b/internet/tethering.jpg){class="glboxshadow"}
