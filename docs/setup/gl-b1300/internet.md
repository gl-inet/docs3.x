...
![cable](https://static.gl-inet.com/docs/en/3/setup/gl-b1300/internet/cable.jpg){class="glboxshadow"}
...
![dhcp](https://static.gl-inet.com/docs/en/3/setup/gl-b1300/internet/dhcp.jpg){class="glboxshadow"}
...
![static](https://static.gl-inet.com/docs/en/3/setup/gl-b1300/internet/static.jpg){class="glboxshadow"}
...
![PPPoE](https://static.gl-inet.com/docs/en/3/setup/gl-b1300/internet/pppoe_page.jpg){class="glboxshadow"}
...
![scan wifi](https://static.gl-inet.com/docs/en/3/setup/gl-b1300/internet/repeater.jpg){class="glboxshadow"}



Choose a SSID from the drop-down list and enter its password. You can also enable the **Remember** button to save the current chose wireless network. Finally, click `Join`.

![wifi connect](https://static.gl-inet.com/docs/en/3/setup/gl-b1300/internet/repeater1.jpg){class="glboxshadow"}
...
![modem](https://static.gl-inet.com/docs/en/3/setup/gl-b1300/internet/modem1.jpg){class="glboxshadow"}
...
![modem](https://static.gl-inet.com/docs/en/3/setup/gl-b1300/internet/modem2.jpg){class="glboxshadow"}
...
![modem](https://static.gl-inet.com/docs/en/3/setup/gl-b1300/internet/modem5.jpg){class="glboxshadow"}
...
![modem connected](https://static.gl-inet.com/docs/en/3/setup/gl-b1300/internet/modem4.jpg){class="glboxshadow"}
...
![tethering](https://static.gl-inet.com/docs/en/3/setup/gl-b1300/internet/tethering.jpg){class="glboxshadow"}
