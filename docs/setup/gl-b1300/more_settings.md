...
![custom dns server](https://static.gl-inet.com/docs/en/3/setup/gl-b1300/more_settings/custom_dns_server.jpg){class="glboxshadow"}
...
![network mode](https://static.gl-inet.com/docs/en/3/setup/gl-b1300/more_settings/network_mode.jpg){class="glboxshadow"}
...
![advanced](https://static.gl-inet.com/docs/en/3/setup/gl-b1300/more_settings/advanced.jpg){class="glboxshadow"}
