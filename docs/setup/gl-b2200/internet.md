...
![connection method](https://static.gl-inet.com/docs/en/3/setup/Velica/Internet/internet-setting-B2200.png){class="glboxshadow"}
...
![internet](https://static.gl-inet.com/docs/en/3/setup/Velica/Internet/B2200_internet_1.png){class="glboxshadow"}
