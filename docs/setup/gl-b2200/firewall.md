...
![Firewall](https://static.gl-inet.com/docs/en/3/setup/gl-s1300/firewall/firewall.jpg){class="glboxshadow"}
...
![Port Forwards](https://static.gl-inet.com/docs/en/3/setup/gl-s1300/firewall/port_forwards.jpg){class="glboxshadow"}
...
![Port Forwards](https://static.gl-inet.com/docs/en/3/setup/gl-s1300/firewall/open_port.jpg){class="glboxshadow"}
...
![Port Forwards](https://static.gl-inet.com/docs/en/3/setup/gl-s1300/firewall/DMZ.jpg){class="glboxshadow"}