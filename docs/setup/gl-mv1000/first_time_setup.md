...
![initial setup](https://static.gl-inet.com/docs/en/3/setup/gl-mv1000/first_time_setup/welcome.png){class="glboxshadow"}
...
![admin panel](https://static.gl-inet.com/docs/en/3/setup/gl-mv1000/first_time_setup/main_ui.png){class="glboxshadow"}
