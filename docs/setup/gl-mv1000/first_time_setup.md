...
![router](https://static.gl-inet.com/docs/router/en/3/setup/gl-mv1000/first_time_setup/mv1000.png){class="glboxshadow"}
...
![Power on](https://static.gl-inet.com/docs/router/en/3/setup/gl-ar750/first_time_setup/power1.jpg){class="glboxshadow"}
...
![connect via lan](https://static.gl-inet.com/docs/router/en/3/setup/gl-ar750/first_time_setup/connect.jpg){class="glboxshadow"}
...
![connect usb type-c cable](https://static.gl-inet.com/docs/router/en/3/setup/gl-ar750/first_time_setup/power1.jpg){class="glboxshadow"}
...
![initial setup](https://static.gl-inet.com/docs/router/en/3/setup/gl-mv1000/first_time_setup/welcome_page_gl-mv1000.png){class="glboxshadow"}
...
![admin panel](https://static.gl-inet.com/docs/router/en/3/setup/gl-mv1000/first_time_setup/admin_panel_gl-mv1000.png){class="glboxshadow"}
