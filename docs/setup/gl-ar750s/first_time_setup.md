...
![router](https://static.gl-inet.com/docs/router/en/3/setup/gl-ar750s/first_time_setup/router.jpg){class="glboxshadow"}
...
![initial setup](https://static.gl-inet.com/docs/router/en/3/setup/gl-ar750s/first_time_setup/welcome_page_gl-ar750s.png){class="glboxshadow"}
...
![admin panel](https://static.gl-inet.com/docs/router/en/3/setup/gl-ar750s/first_time_setup/admin_panel_gl-ar750s.png){class="glboxshadow"}
