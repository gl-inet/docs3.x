...
![admin password](https://static.gl-inet.com/docs/en/3/setup/gl-ar750s/more_settings/admin_password.jpg){class="glboxshadow"}
...
![time zone](https://static.gl-inet.com/docs/en/3/setup/gl-ar750s/more_settings/time_zone.jpg){class="glboxshadow"}
...
![mac clone](https://static.gl-inet.com/docs/en/3/setup/gl-ar750s/more_settings/mac_clone.jpg){class="glboxshadow"}
...
![custom dns server](https://static.gl-inet.com/docs/en/3/setup/gl-ar750s/more_settings/custom_dns_server.jpg){class="glboxshadow"}
...
![button settings](https://static.gl-inet.com/docs/en/3/setup/gl-ar750s/more_settings/button_settings.jpg){class="glboxshadow"}
...
![network mode](https://static.gl-inet.com/docs/en/3/setup/gl-ar750s/more_settings/network_mode.jpg){class="glboxshadow"}
...
![revert firmware](https://static.gl-inet.com/docs/en/3/setup/gl-ar750s/more_settings/revert_firmware.jpg){class="glboxshadow"}
...
![advanced](https://static.gl-inet.com/docs/en/3/setup/gl-ar750s/more_settings/advanced.jpg){class="glboxshadow"}
