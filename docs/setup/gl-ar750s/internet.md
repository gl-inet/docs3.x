...
![internet page of gl-ar750s](https://static.gl-inet.com/docs/router/en/3/setup/gl-ar750s/internet/internet_page_gl-ar750s.png){class="glboxshadow"}
...
![connection method](https://static.gl-inet.com/docs/router/en/3/setup/gl-ar750s/internet/4ways.jpg){class="glboxshadow"}
