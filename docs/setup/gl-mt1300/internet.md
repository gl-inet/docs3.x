...
![connection method](https://static.gl-inet.com/docs/en/3/setup/gl-mt1300/internet-setting-MT1300.png){class="glboxshadow"} 4 internet methods image to be updated

Click `INTERNET` to create an Internet connection.

![internet](https://static.gl-inet.com/docs/en/3/setup/gl-mt1300/admin_panel.png){class="glboxshadow"} 
...
![modem](https://static.gl-inet.com/docs/en/3/setup/share/internet/modem1.png){class="glboxshadow"}
...
![modem connect](https://static.gl-inet.com/docs/en/3/setup/share/internet/modem2.png){class="glboxshadow"}

![modem connected](https://static.gl-inet.com/docs/en/3/setup/share/internet/modem3.png){class="glboxshadow"}
