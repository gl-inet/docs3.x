...
![router](https://static.gl-inet.com/docs/router/en/3/setup/gl-mt1300/first_time_setup/gl-mt1300.jpg){class="glboxshadow"}
...
![Power on](https://static.gl-inet.com/docs/router/en/3/setup/gl-mt1300/first_time_setup/power_up.jpg){class="glboxshadow"}
...
![connect via lan](https://static.gl-inet.com/docs/router/en/3/setup/gl-mt1300/first_time_setup/plug.jpg){class="glboxshadow"}
...
![initial setup](https://static.gl-inet.com/docs/router/en/3/setup/gl-mt1300/first_time_setup/welcome_page_mt1300.png){class="glboxshadow"}
...
![admin panel](https://static.gl-inet.com/docs/router/en/3/setup/gl-mt1300/first_time_setup/admin_panel_mt1300.png){class="glboxshadow"}
