...
![tftp install](https://static.gl-inet.com/docs/router/en/2/dev/src/tftpd-install.png){class="glboxshadow"} 

Turn off windows firewall, which is the main reason causing tftpd failed to connect.

![tftp install](https://static.gl-inet.com/docs/router/en/2/dev/src/firewall.png){class="glboxshadow"} 
...
![tftp install](https://static.gl-inet.com/docs/router/en/2/dev/src/tftpd-status.png){class="glboxshadow"} 
...
![Uboot Web UI](https://static.gl-inet.com/docs/router/en/2/dev/src/uboot_failsafe.png){class="glboxshadow"}
