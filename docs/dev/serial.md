...
![UART](https://static.gl-inet.com/docs/router/en/2/dev/src/uart_serial.jpg){class="glboxshadow"}
...
![Com](https://static.gl-inet.com/docs/router/en/2/dev/src/find-serial-port.jpg){class="glboxshadow"}
...
![Putty](https://static.gl-inet.com/docs/router/en/2/dev/src/putty.png){class="glboxshadow"}

You will be displayed a black window. If you turn on your device now, you will see the console output of the box.


![Putty](https://static.gl-inet.com/docs/router/en/2/dev/src/putty1.png){class="glboxshadow"}

Dual Serial connection on Domino Pi
-------------------------------
Domino Pi has dual serial connection, please refer to <a href='https://docs.gl-inet.com/router/en/2/domino/pi/serial/'>Domino Pi Serial</a> for details.
