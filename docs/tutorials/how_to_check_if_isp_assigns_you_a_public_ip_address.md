...
![is public ip address](https://static.gl-inet.com/docs/en/3/tutorials/how_to_check_if_isp_assigns_you_a_public_ip_address/is_public_ip_address.png){class="glboxshadow"}
