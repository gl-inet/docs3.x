...
![setup wireguard manually](https://static.gl-inet.com/docs/en/3/tutorials/wireguard/setup_wireguard_manually.png)

### Input the configuration

There are different methods to input the configuration.

![paste wireguard config](https://static.gl-inet.com/docs/en/3/tutorials/wireguard/paste_wireguard_config.png)
...
![add a new wireguard config](https://static.gl-inet.com/docs/en/3/tutorials/wireguard/add_a_new_wireguard_config.png)

### Specify the name of your server

Specify a descriptive name and then click `Next`.

![config name](https://static.gl-inet.com/docs/en/3/tutorials/wireguard/input_config_name.png)

![connect wireguard](https://static.gl-inet.com/docs/en/3/tutorials/wireguard/wireguard_connect.png)

Choose the server and click `Connect`.

![wireguard connected](https://static.gl-inet.com/docs/en/3/tutorials/wireguard/wireguard_connected.png)
...
<details>
  ...
  <p>
    <img src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/setup_azirevpn.png" alt="Configuraion" />
  </p>
...
<summary>Mullvad</summary>
  ...
  <p>
    <img src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/setup_mullvadvpn.png" alt="Configuraion" />
  </p>
  <p>
...
<details>
  ...
  <ol type="1">
    <li>
      ...
      <p>
        <img alt="" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/ovpn/get_wireguard_configuration_files.jpg"/>
      </p>
    </li>
    <li>
      <p>Click Generate WireGuard keys, choose the server you wanted, then download the config.</p>
      <p>
        <img alt="" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/ovpn/download_wireguard_configuration_files.jpg"/>
      </p>
    </li>
    <li>
      <p>
      ...
      <p>
        <img alt="remove wireguard ipv6 content" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/ovpn/remove_wireguard_ipv6_content.jpg" />
      </p>
    </li>
    <li>
      <p>
      ...
      <p>
        <img alt="setup wireguard manually" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/setup_wireguard_manually.png" />
      </p>
    </li>
    <li>
      <p>
      ...
      <p>
        <img alt="paste wireguard config" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/add_a_new_wireguard_config.png" />
      </p>
    </li>
    <li>
      <p>
      ...
      <p>
        <img alt="input config name" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/input_config_name.png" />
      </p>
    </li>
    <li>
      <p>
      ...
      <p>
        <img alt="connect wireguard" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/wireguard_connect.png" />
      </p>
    </li>
    <li>
      <p>
      ...
      <p>
        <img alt="wiregaurd connected" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/wireguard_connected.png" />
      </p>
    </li>
  </ol>
</details>
...
<details>
  ...
  <ol type="1">
    <li>
      ...
      <p>
        <img alt="get spider vpn configuration" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/spidervpn_config_1.jpg" />
      </p>
    </li>
    <li>
      <p>Download the vpn configuration</p>
      <p>
        <img alt="download spider vpn configuration" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/spidervpn_config_2.jpg" />
      </p>
    </li>
    <li>
...
<details>
  ...
  <ol type="1">
    <li>
      ...
      <p>
        <img alt="torguard enable wireguard access" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/torguard/torguard_menu.jpg" />
      </p>
    </li>
    <li>
      <p>
      ...
      <p>
        <img alt="torguard generate wireguard config" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/torguard/torguard_generate_wireguard_config.png" />
      </p>
      <p>
        You can find the <b>VPN Username</b> and <b>VPN Password</b> below
      </p>
      <p>
        <img alt="torguard vpn username vpn password" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/torguard/torguard_vpnusername_vpnpassword.png" />
      </p>
    </li>
    <li>
      <p>
...
<details id="strongvpn">
  ...
  <ol type="1">
    <li>
      ...
      <p><img alt="VPN.AC WireGuard Manager" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/vpn.ac_wireguard_manager.jpg" /></p>
    </li>
    <li>
      <p>Create the config and download.</p>
      <p><img alt="VPN.AC create wireguard profiles" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/vpn.ac_create_wireguard_profiles.jpg" /></p>
    </li>
    <li>
    ...
    <li>
      <p>Login web Admin Panel, VPN --> WireGuard Client --> Set up WireGuard Manually</p>
      <p><img alt="setup wireguard manually" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/setup_wireguard_manually.png" /></p>
    </li>
    <li>
      <p>Paste the configuration text to the Configuration windows. Click <b>Next</b></p>
      <p><img alt="paste wireguard config" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/add_a_new_wireguard_config.png" /></p>
    </li>
    <li>
      <p>Specify the name of your server and click <b>Add</b></p>
      <p><img alt="input config name" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/input_config_name.png" /></p>
    </li>
    <li>
      <p>Connect to the WireGuard server by clicking <b>Connect</b></p>
      <p><img alt="connect wireguard" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/wireguard_connect.png" /></p>
    </li>
    <li>
      <p>You will see the upload and download traffic when it is connected successfully.</p>
      <p><img alt="wiregaurd connected" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/wireguard_connected.png" /></p>
    </li>
  </ol>
</details>
...
<details>
  ...
  <ol type="1">
    ...
    <li>
      ...
      <p><img alt="strongvpn wireguard configuration generator" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/strongvpn/strongvpn_wireguard_configuration_generator.png" /></p>
    </li>
    <li>
      <p>Open the config by text edit software, copy the content.</p>
    </li>
...
<details>
  ...
  <ol type="1">
    <li>
      ...
      <p><img alt="wevpn manual configuration generator" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/wevpn/wevpn_1.jpg" /></p>
    </li>
    <li>
      <p>When you select the WireGuard protocol, you will need to select <b>Add device</b> for the region selected.</p>
      <p><img alt="wevpn manual configuration generator" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/wevpn/wevpn_2.jpg" /></p>
    </li>
    <li>
...
<details>
  ...
  <ol type="1">
    <li>
      ...
      <p><img alt="windscribe WireGuard Config Generator" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/windscribe/windscribe_01.jpg" /></p>
    </li>
    <li>
...
<details>
  ...
  <ol type="1">
    <li>
      ...
      <p><img alt="PrivateVPN Control panel" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/privatevpn/privatevpn_wireguard_1.jpg" /></p>
    </li>
    <li>
      <p>Select a server</p>
      <p><img alt="select a server" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/privatevpn/privatevpn_wireguard_2.jpg" /></p>
    </li>
    <li>
      <p>Click GENERATE CONFIG, then copy the config.</p>
      <p><img alt="generate config" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/privatevpn/privatevpn_wireguard_3.jpg" /></p>
    </li>
    <li>
      <p>Paste the configuration text to the Configuration windows. Click <b>Next</b></p>
      <p><img alt="paste wireguard config" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/add_a_new_wireguard_config.png" /></p>
...
<details>
  ...
  <ol type="1">
    <li>
      ...
      <p><img alt="vpn unlimited setup on gl.inet router" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/vpnunlimited/01.jpg" /></p>
    </li>
    <li>
      ...
      <p><img alt="vpn unlimited setup on gl.inet router" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/vpnunlimited/02.jpg" /></p>
    </li>
    <li>
      ...
      <p><img alt="vpn unlimited setup on gl.inet router" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/vpnunlimited/03.jpg" /></p>
    </li>
    <li>
      <p>Login web Admin Panel, VPN --> WireGuard Client --> Set up WireGuard Manually</p>
      <p><img alt="setup wireguard manually" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/setup_wireguard_manually.png" /></p>
    ...
    <li>
      ...
      <p><img alt="vpn unlimited setup on gl.inet router" src="https://static.gl-inet.com/docs/en/3/tutorials/wireguard/vpnunlimited/add_a_new_wireguard_config.png" /></p>
...
![1531206410246](https://static.gl-inet.com/docs/en/3/tutorials/wireguard/WGC5.png)
